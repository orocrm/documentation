.. _user-guide--business-intelligence--widgets--leads-statistics:
...
* **Territories** --- if sales `territories <https://www.oroinc.com/doc/orocrm/current/user-guide-sales-tools/b2b-sales/territory-management>`_ are enabled in your system, you can view leads filtered within one or several specific territories.
