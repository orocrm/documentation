...
4. In the **Assign Event To** dialog box, specify the required data. For help on this, see the **Add an Event for a Related Record** section of the `Add a Calendar Event <doc-activities-events-actions-add-detailed>` guide.
...
4. In the **Assign Task To** dialog box, specify the required data. For help on this, see the :ref:`Create a Task <doc-activities-tasks-actions-add-detailed>` guide.
