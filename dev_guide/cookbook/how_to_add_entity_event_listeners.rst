...
Suppose that you have already extended an Oro bundle like ``OroContactBundle`` (you can find more information in the :ref:`How to extend existing bundle <how-to-extend-existing-bundle>` topic).
